...
export default function NewItem(){
    ...
    const handleSubmit = (event) => {
        ...
        console.log(ItemObject); //Added
        alert(JSON.stringify(ItemObject));//Added
    }
    ...
    let titleStyles = "justify-center bg-blue-950 text-amber-100 rounded-lg w-fit border-black border-2 flex flex-row p-0.5" //Added
    let divSet = "justify-center w-full flex p-1 space-x-3" //Added
    ...
    return(//added form and input elements
        <main className="mt-4 ml-40 mr-40 bg-amber-950 flex flex-col items-center rounded-lg p-4 space-y-4">
            <form className="justify-center space-y-4 w-full flex flex-wrap " onSubmit={handleSubmit}>
